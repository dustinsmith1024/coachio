...
class PracticesControllerTest < ActionController::TestCase
  ...
  test "should create practice" do
    assert_difference('Practice.count') do
      post :create, practice: { scheduled_date: @practice.scheduled_date, scheduled_time: @practice.scheduled_time, track_results: @practice.track_results }
    end
  ...
  test "should update practice" do
    put :update, id: @practice, practice: { scheduled_date: @practice.scheduled_date, scheduled_time: @practice.scheduled_time, track_results: @practice.track_results }
    assert_redirected_to practice_path(assigns(:practice))
  end
